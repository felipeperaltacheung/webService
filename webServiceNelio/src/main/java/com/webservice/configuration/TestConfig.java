...
import com.webservice.entities.*;
import com.webservice.entities.enums.OrderStatus;
import com.webservice.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        p1.getCategories().add(cat2); //associacao entre os objetos
        ...
        o1.setPayment(pay1); // associando o pedido o1 passando o pagamento 1
